...
function loadArticle(){
    ...
    common.ajax("/activity/production/get/"+getLocVal("pk_article_id"), {
		...
		if(obj.neverTotal) $("#score").html(obj.neverTotal+"分");
        ...
        for (var j = 0; j < arr.length; j++) {
            var divImg = "<div style='width:100%;'><img class='click' onclick='openbrower("+ j +");' src='" + "http://www.readseed.cn" + arr[j] + "' style='width:100%;height:100%'></div>";
            //alert(divImg);
