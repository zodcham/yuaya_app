...
appcan.ready(function() {
    ...
    appcan.frame.open("content", "article_mylist_content.html", 0, titHeight);
...
appcan.button("#share_weixin", "btn-act", function() {
    getUserInfo();
    var jsonstr0 = '{"thumbImg":"http://www.readseed.cn/yueya_webapp/icon.png","wedpageUrl":"http://www.readseed.cn/yueya_webapp/pk/article_mylist.html?'+getLocVal("pk_id")+'?'+userInfo.id+'?","scene":"0","title":"' + pushTitle + '","description":"分享一下"}';
    uexWeiXin.shareLinkContent(jsonstr0);
})

appcan.button("#share_weixinquan", "btn-act", function() {
    getUserInfo();
    var jsonstr1 = '{"thumbImg":"http://www.readseed.cn/yueya_webapp/icon.png","wedpageUrl":"http://www.readseed.cn/yueya_webapp/pk/article_mylist.html?'+getLocVal("pk_id")+'?'+userInfo.id+'?","scene":"1","title":"' + pushTitle + '","description":"分享一下"}';
