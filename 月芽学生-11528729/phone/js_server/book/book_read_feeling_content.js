...
appcan.ready(function() {
    ...
    AddLogContent(userInfo.id, logKeys.BookReviewDetail, {"reviewId":readFeeling.id});
...
function addLike(reviewId) {
    ...
    common.ajax("/bookReview/addLikes", {
        ...
        AddLogContent(userInfo.id, logKeys.BookReviewLike, {"reviewId":readFeeling.id});
...
function doSubmit() {
    ...
    if (replyId.length > 0) {
        ...
        common.ajax("/reviewComment/save", {
            ...
            AddLogContent(userInfo.id, logKeys.BookReviewAddComment, {"reviewCommentId":data.obj});
