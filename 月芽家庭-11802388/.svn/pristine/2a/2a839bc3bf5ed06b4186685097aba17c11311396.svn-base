...
appcan.ready(function() {
    ...
    getUserInfo();
    g_pid=getLocVal("posts_edit_id");
    var url=_SERVER_ADDRESS+"/group/findPost"; 
   var par={'userid' : userInfo.id,'pid' : g_pid};
...
function doSubmit() {
    ...
    var url = _SERVER_ADDRESS + "/group/updatePost";
    var par = {
        'userid' : userInfo.id,
