...
//alert($("#main").css("width"));
    ...
    $("#img_word").attr("title","博览群书"+" "+ GetMetelStar(word_metel_type,word_star)).attr("remark","阅读图书的字数(千字)").attr("star",word_star).attr("exp",g_json.word_count).attr("next",word_next).attr("helptype","word");
