                   ...
                   if(value["postlist"].length>0){
                       ...
                       $.each(floor,function(index, v) {
                                ...
                                if(v.userid==userInfo.id){
                                    ...
                                    postshtml+='<input type="button" style="width:2.5em; border-width:0; text-align:center; font-size:1em;  background-color:#F16412 ;color:#fff;border-radius: 0.3em;margin-left:1.5em;"  onclick="del_posts(\''+v.pid+'\',\''+v.tid+'\')"  value="清除">';
                                }
                                postshtml+='</p>';
                        })
