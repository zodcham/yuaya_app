...
appcan.button("#privacy", "btn-act", function() {
    appcan.window.open("privacy", "privacy.html", 5);
})

appcan.button("#protocol", "btn-act", function() {
    appcan.window.open("protocol", "protocol.html", 5);
})
...
appcan.button("#register", "btn-act", function() {
    appcan.window.open("applyPass","register.html",10);
