            ...
            if (data.obj.count == 0) {
                ...
                if (list) {
                    for (var i = list.length-1; i >= 0; i--) {
                        ...
                        var personCount = obj.reStudentCount / obj.studentCount;//人均任务量

                        var finishRate = obj.reFinishStudentCount / obj.studentCount;//完成率

                        personReviewCount = obj.reviewCount / obj.studentCount;//人均读后感 =读后感/ 学生人数

                        var readStudentRate = (obj.reviewStudentCount / obj.studentCount) * 100;//参与阅读率
