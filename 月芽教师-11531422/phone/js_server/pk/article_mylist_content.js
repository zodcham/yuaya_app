        ...
        if (pageIndex == 1 && data.obj.count == 0) {
            ...
            if (list) {
                for (var i = 0; i < list.length; i++) {
                    ...
                    if (obj.studentPhoto) {
                        objItem.find(".user-Photo").attr("src", _SERVER_ADDRESS + obj.studentPhoto);
                    }
                    ...
                    objItem.find(".like").html('点赞:'+obj.likeTimes);
                    objItem.find(".like").attr("value", obj.likeTimes);

                    objItem.find(".comments").html('评论:'+obj.commentTimes);
                    ...
                    for (var j = 0; j < arr.length; j++) {
                        var divImg = $("<div class='umar-r ub-f1'><img class='click' src='" + _SERVER_ADDRESS + arr[j] + "' style='width:100%;height:100%'></div>");
