...
function loadInfo() {
    ...
    common.ajax("/readingReport/get", {
        ...
        $(".bookCountRateName").html("(" + data.obj.taskFinishBookCount + "本/" + data.obj.taskBookCount + "本)");
        $(".wordCountRateName").html("(" + data.obj.taskFinishWordCount + "千字/" + data.obj.taskWordCount + "千字)");
        $(".reviewRateName").html("(" + data.obj.taskFinishReviewCount + "篇/" + data.obj.taskReviewCount + "篇)");
