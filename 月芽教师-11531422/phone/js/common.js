...
var conMsg = {
    ...
    'NOT_EXISTS_PHONE':'用户名和手机号码不匹配,请查证后再试',
    'SEND_VERIFYCODE_FAIL':'发送验证码失败',
    'SEND_VERIFYCODE_ERROR':'验证码错误或已经无效',
    'EXSITS_LOGINNAME':'账号已存在',
    'EXSITS_EMAIL':'邮箱地址已被使用',
...
var common = {
    showUnkownError : function() {
        uexWindow.toast('0', '5', conMsg.unkownError, config.toastTimeLong);
    },
    ...
    var prompt={
        ...
        show:function(value,el,icon){
                ...
                var con = "<div id='"+prompt.id+"' class='ub ub-ver ub-ac ub-pc' style='position: absolute;width:100%;height:100%;left:0;top:0;z-index:9999999'>";
                    con += "<div class='ub ub-ac ub-pc'><image src='../css/image1/ico_shoujianxiang@2x_11.png' style='width:5em;height:3em' /></div>";
