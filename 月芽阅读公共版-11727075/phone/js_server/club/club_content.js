...
function loadForum(id) {
    ...
    var fok = function(data) {
        ...
        $.each(data, function(index, value) {
             ...
             */
            htm += '<div class="ub ub-ac listchild" onclick="openforum(' + value["cid"] + ', ' + value["gid"] + ', \'' + value["title"] + '\')" style="font-size:36px;border-bottom:5px solid #90c748;height:350px;">';
            htm += '     <div class="div_img"><img src="' + img + '" class="forumimg"></div>';
            htm += '     <div class="ub ub-ver" style="margin-left:30px;font-size:48px;">';
