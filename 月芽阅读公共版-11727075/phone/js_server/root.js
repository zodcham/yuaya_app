appcan.ready(function() {
    if(CONNECTSTATUS_FLAG){
        ...
        var par = {
            //"deviceId" : cDeviceToken.toUpperCase()
            "deviceId" : '8C:F7:10:C4:E3:87'
        };
		appcan.logs(cDeviceToken);
...
function LoadData(data){
	...
	var width_screen =  uexWindow.getWidth();
    var height_screen = uexWindow.getHeight();
