...
function checkVersion() {
    if (isCheck) {
        if(sysInfo.phoneType == "1") {
            return;
            //'1':'Android', '0':'IOS'
            var params={ 'version' : version,'phoneType' : "1","userType":"student"};//teacher
...
//                     
                    // sysInfo.updateInfo = data.obj;
                    // setSysInfo();
                    // alert("最新版本才能正常使用，请更新，谢谢。");
//                     
                    // clearCommInfo();
                    // getDefaultUserInfo();
                    // setUserInfo(false);
//                     
                    // uexWidget.loadApp("itms://itunes.apple.com/cn/app/id1142185442?mt=8");
//          
                   // /*
