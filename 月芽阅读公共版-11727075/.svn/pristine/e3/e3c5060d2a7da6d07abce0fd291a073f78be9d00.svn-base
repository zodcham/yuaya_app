...
function openShareWin(index){
    ...
    switch (index) {
        case 0:
            searchType="grade";
            $(".btn0").attr("src","../images/circle/btn0_2.png");
            $("#bookList").empty();
            pageIndex = 1;
            myPrompt.hide();
            loadData();
        ...
        case 1:
            searchType="school";
            $(".btn1").attr("src","../images/circle/btn1_2.png");
            $("#bookList").empty();
            pageIndex = 1;
            myPrompt.hide();
            loadData();
        ...
        case 2:
            searchType="area";
            $(".btn2").attr("src","../images/circle/btn2_2.png");
            $("#bookList").empty();
            pageIndex = 1;
            myPrompt.hide();
            loadData();
        ...
        case 3:
            searchType="plate";
            $(".btn3").attr("src","../images/circle/btn3_2.png");
            $("#bookList").empty();
            pageIndex = 1;
            myPrompt.hide();
            loadData();
            break;
        case 4:
            //$(".btn4").attr("src","../images/circle/btn4_2.png");
            $("#AreaId2").click();
            break;
    }
...
function resetHeadButton(){
    $(".btn0").attr("src","../images/circle/btn0.png");
    $(".btn1").attr("src","../images/circle/btn1.png");
    $(".btn2").attr("src","../images/circle/btn2.png");
    $(".btn3").attr("src","../images/circle/btn3.png");
    $(".btn4").attr("src","../images/circle/btn4.png");
}
...
appcan.button(".shares", "btn-act", function() {
    appcan.window.open("share_introduce_add", "share_introduce_add.html", 5);
})
function loadData() {
            ...
            for (var i = 0; i < data.obj.list.length; i++) {
                ...
                objItem.find(".abc").on("click", function() {
                    ...
                    getProgramInfoById(id, function(data) {
                        ...
                        programInfo = data;
                        setProgramInfo();
                        appcan.window.open("share_index", "share_index.html", 5);
                    }, null);
                });
