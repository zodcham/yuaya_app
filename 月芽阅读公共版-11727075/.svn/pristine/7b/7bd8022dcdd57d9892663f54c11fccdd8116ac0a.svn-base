                    ...
                    if(obj.replyList.length>0){
                        ...
                        $.each(obj.replyList, function(idx, obj1) {
                            ...
                            if(obj1.isTeacher==1)
                                ...
                                htm+='<div class="ub ub-fh ub-ver comment ulev-2" style="color:#fff;"><span class="teacher_name">'+obj1.userName+'</span>：</div>';
                            htm+='<div class="ub ub-fh imgs umar-t ulev-1 sc-text" style="color:#fff;">'+obj1.content+'</div>';
                            htm+='<div class="ub ub-fh imgs umar-t ulev-2 sc-text" style="color:#fff;">'+obj1.createDate+'</div>';
                            htm+='</div>';
                        });
                        htm+='</div>';
