...
appcan.ready(function() {
    ...
    $(".header_bookName").html(bookInfo.name);
    //安卓返回键
...
function OpenIntroWindow(){
    ...
    appcan.frame.open("openwindow", url, 1201, 88);
}
...
function OpenWin(t) {
    ...
    switch(t) {
        ...
        default:
            ...
            appcan.frame.open("openwindow", url, 1021, 88);
            break;
    }
}
...
function OpenReview() {
    alert(titHeight);
    appcan.frame.open("content_review", "book_index_content.html", 1021, 88);
}
