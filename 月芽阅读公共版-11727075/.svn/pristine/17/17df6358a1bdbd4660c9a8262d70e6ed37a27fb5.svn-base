...
function ClickBack(){
	...
	if(url.indexOf("message_content.html")>0 && url.indexOf("yueduquan")>0){
		...
		else if(winName=="column_index_introduce_content" || winName=="column_index_comments" || winName=="column_index_introduce"){
             winName="column_index";
        }
...
function setHomeBackBtn(){
    var url=location.href;
    //alert(pageName());
	if(pageName()=="default_content.html"){
	...
	if(pageName()=="tv_index.html" || pageName()=="tv_home.html" || pageName()=="tv_mall.html" || pageName()=="tv_ppt.html" || pageName()=="tv_video.html" || pageName()=="tv_audio.html"){
        return true;
    }
	if(pageName()=="book_review.html"){
        return true;
    }
